...
headers: {
  ...
  axios.request(optionsPc).then(function (response) {
...
headers: {
  ...
  axios.request(optionsBrowser).then(function (response) {
...
headers: {
  ...
  axios.request(optionsrelease).then(function (response) {
...
headers: {
  ...
  axios.request(optionspop).then(function (response) {
...
headers: {
  ...
  axios.request(optionsalpha).then(function (response) {
...
headers: {
  ...
  axios.request(optionsrelevance).then(function (response) {
...
const [dataopenworld, setdataopenworld] = useState([])
  ...
  axios.request(optionsopenworld).then(function (response) {
...
const [datashooter, setdatashooter] = useState([])
  ...
  axios.request(optionsshooter).then(function (response) {
...
const [dataracing, setdataracing] = useState([])
  ...
  axios.request(optionsracing).then(function (response) {
...
const [datasocial, setdatasocial] = useState([])
  ...
  axios.request(optionssocial).then(function (response) {
...
const [datasports, setdatasports] = useState([])
  ...
  axios.request(optionssports).then(function (response) {
...
const [datazombie, setdatazombie] = useState([])
  ...
  axios.request(optionszobmie).then(function (response) {
